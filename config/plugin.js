...
// doraTopicPluginBegin
exports.doraTopic = {
    enable: true,
    package: 'egg-dora-topic',
    path: path.join(__dirname, "../lib/plugin/egg-dora-topic")
};
// doraTopicPluginEnd
...
exports.doraNode = {
    ...
    path: path.join(__dirname, "../lib/plugin/egg-dora-node")
};
// doraNodePluginEnd

// doraTopicCategoryPluginBegin
exports.doraTopicCategory = {
    enable: true,
    package: 'egg-dora-topiccategory',
    path: path.join(__dirname, "../lib/plugin/egg-dora-topiccategory")
};
// doraTopicCategoryPluginEnd
