...
var siteFunc = {
    ...
    renderSimpleNode(htmlStr, imgLinkArr, videoLinkArr) {
    ...
    checkNodeType(htmlStr, type = 'content') {
    ...
    clearUserSensitiveInformation(targetObj) {
        ...
        targetObj.praiseCommunityNode && delete targetObj.praiseCommunityNode;
        targetObj.praiseMessages && delete targetObj.praiseMessages;
        targetObj.praiseNodes && delete targetObj.praiseNodes;
        targetObj.favoriteCommunityNode && delete targetObj.favoriteCommunityNode;
        targetObj.favorites && delete targetObj.favorites;
        targetObj.despiseCommunityNode && delete targetObj.despiseCommunityNode;
