...
var siteFunc = {
    ...
    renderSimpleTopic(htmlStr, imgLinkArr, videoLinkArr) {
    ...
    checkTopicType(htmlStr, type = 'content') {
    ...
    clearUserSensitiveInformation(targetObj) {
        ...
        targetObj.praiseCommunityTopic && delete targetObj.praiseCommunityTopic;
        targetObj.praiseMessages && delete targetObj.praiseMessages;
        targetObj.praiseTopics && delete targetObj.praiseTopics;
        targetObj.favoriteCommunityTopic && delete targetObj.favoriteCommunityTopic;
        targetObj.favorites && delete targetObj.favorites;
        targetObj.despiseCommunityTopic && delete targetObj.despiseCommunityTopic;
