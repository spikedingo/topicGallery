...
global.getTopicListFields = (type = '') => {

  let files = null;
  if (type == 'normal') {
    files = '_id title type categories nodes state clickNum commentNum likeNum keywords rank execed execTimes correctRate title sortPath discription date updateDate'
  } else if (type == 'simple') {
    files = '_id title type categories nodes state clickNum commentNum likeNum keywords rank execed execTimes correctRate title sortPath discription date updateDate'
  } else if (type == 'stage1') {
    files = '_id title type categories nodes state clickNum commentNum likeNum keywords rank execed execTimes correctRate title sortPath discription date updateDate'
